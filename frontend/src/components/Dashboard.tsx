            ...
            {competitors.map((c, i) => {
              ...
              return (
                <div key={c.id}>
                  ...
                  <div className="flex justify-between text-xs mb-1">
                    <span className="text-slate-500">Defect probability</span>
      ...
      {lastResult && (
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 mb-4">
          ...
          <div className="grid grid-cols-4 gap-4">
            <div>
              <div className="text-xs text-slate-600 mb-1">Nash Equilibrium</div>
            ...
            <div>
              <div className="text-xs text-slate-600 mb-1">Round Decisions</div>
              <div className="text-sm font-bold text-amber-400">
                {Object.values(lastResult.decisions).join(" · ")}
              </div>
            </div>
            <div>
